import { c as create_ssr_component, b as add_attribute, d as escape, e as each, v as validate_component } from "../../../chunks/index2.js";
...
const Register = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  const states = [
    ...
    {
      name: "West Bangal",
      cities: ["Kolkata", "Liluhah", "Srirampur", "Konnagar", "Bally"]
    },
    {
      name: "Bihar",
      cities: ["Patna", "Ara", "Bhagalpur", "Munger", "Hazipur"]
    },
    {
      name: "Utter Pradesh",
      cities: ["Lakhnaow", "Khanpur", "Ballia", "Noida", "Varansai"]
    }
  ];
  $$result.css.add(css);
